...
def _flash_attention_forward_kernel(
    ...
    # Initialize pointers and accumulators for the online softmax.
    ...
    # Main loop: Iterate over blocks of keys (K_j) and values (V_j).
    for start_n in range(0, SEQ_LEN, BLOCK_N):
        ...
        # Find the new running maximum (`m_new`).
    ...
    # Normalize the accumulator and write the output block.
